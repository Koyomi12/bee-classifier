...
from daily_data_processing import IMAGE_SIZE, TAGGED_DANCE_DIR, UNTAGGED_DANCE_DIR
from inference import (
    TAGGED,
    TaggedBeeClassifierConvNet,
    class_labels,
    dict_to_csv,
)

ZIPS_PATH = Path("/home/niklas/Documents/dev/uni/bees/bee-data/zipped")
TARGET = Path("/home/niklas/Documents/dev/uni/bees/bee-data/samples")
